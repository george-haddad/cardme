...
/* ********  E N C O D I N G   M E T H O D S  ******** */    
    ...
    public static String encodeBytes( byte[] source, int off, int len ) {
        ...
        // we're not going to have an java.io.IOException thrown, so
        // we should not force the user to have to catch it.
        String encoded =  encodeBytes( source, off, len, NO_OPTIONS );
        assert encoded != null;
        return encoded;
    }   // end encodeBytes
    ...
    public static byte[] encodeBytesToBytes( byte[] source ) {
        byte[] encoded  = encodeBytesToBytes( source, 0, source.length, Base64.NO_OPTIONS );
        return encoded;
    }
        ...
        for( i = off; i < off+len; i++ ) {  // Loop through source
            ...
            if( sbiDecode >= WHITE_SPACE_ENC )  {
                ...
                throw new RuntimeException( String.format(
                	"Bad Base64 input character decimal %d in array position %d", Integer.valueOf(source[i]&0xFF), Integer.valueOf(i)));
            }   // end else: 
